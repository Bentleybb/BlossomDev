...
const products = [
  {
    ...
    fullDescription:
      "Comfortable cotton t-shirt, crafted from 100% breathable cotton for all-day wear. Perfect for layering or wearing solo during warmer months.",
    price: 20,
    sizes: ["S", "M", "L"],
  ...
  },
  {
    ...
    fullDescription:
      "Warm and cozy hoodie made from ultra-soft fleece lining, ideal for chilly evenings or casual streetwear looks. Breathable and designed for everyday comfort.",
    price: 40,
    sizes: ["S", "M", "L"],
    colors: ["Black", "White", "Blue", "Pink"],
    category: "Jackets",
  ...
  },
  {
    ...
    fullDescription:
      "Durable cargo pants made with reinforced stitching and stretch fabric for flexibility. Designed for utility and comfort with multiple deep pockets.",
    price: 35,
    sizes: ["S", "M", "L"],
    colors: ["Black", "White", "Blue", "Pink"],
    category: "Pants",
  ...
  },
  {
    ...
    fullDescription:
      "Stylish cotton cap with adjustable strap for a perfect fit. Lightweight and breathable, ideal for sunny days and sporty looks.",
    price: 15,
    sizes: ["S", "M", "L"],
    colors: ["Black", "White", "Blue", "Pink"],
  ...
  },
  {
    ...
    fullDescription:
      "Classic blue denim jacket with a vintage wash and modern fit. Versatile layering piece suitable for all seasons with reinforced seams for durability.",
    price: 60,
    sizes: ["S", "M", "L"],
    colors: ["Black", "White", "Blue", "Pink"],
    category: "Jackets",
  ...
  },
  {
    ...
    fullDescription:
      "Comfy and casual sneakers with cushioned soles for all-day comfort. Designed for versatility — whether you're walking, running errands, or relaxing.",
    price: 75,
    sizes: ["S", "M", "L"],
    colors: ["Black", "White", "Blue", "Pink"],
    category: "Shoes",
  ...
  },
  {
    ...
    fullDescription:
      "Soft woolen scarf spun from premium fibers to keep you warm in the coldest weather. Stylish and cozy with a unisex appeal.",
    price: 25,
    sizes: ["S", "M", "L"],
    colors: ["Black", "White", "Blue", "Pink"],
    category: "Accessories",
  ...
  },
  {
    ...
    fullDescription:
      "Athletic fit joggers with elastic waistband and tapered legs. Perfect for workouts or lounging, made from lightweight performance fabric.",
    price: 30,
    sizes: ["S", "M", "L"],
    colors: ["Black", "White", "Blue", "Pink"],
    category: "Pants",
  ...
  },
  {
    ...
    fullDescription:
      "Warm knit beanie crafted from premium yarn for maximum heat retention. Stretchable and snug — great for winter or casual streetwear.",
    price: 18,
    sizes: ["S", "M", "L"],
    colors: ["Black", "White", "Blue", "Pink"],
    category: "Accessories",
      ...
      <button
        ...
        onClick={() => {
          if (!auth.isAuthenticated()) {
            ...
            setSelectedProduct(null); // Optionally close modal on add
          }
        }}
      >
        Add to Cart
